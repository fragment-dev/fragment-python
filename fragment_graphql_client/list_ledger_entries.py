...
class ListLedgerEntriesLedger(BaseModel):
    ledger_entries: Optional["ListLedgerEntriesLedgerLedgerEntries"] = Field(
        alias="ledgerEntries"
    )


class ListLedgerEntriesLedgerLedgerEntries(BaseModel):
    nodes: Optional[List["ListLedgerEntriesLedgerLedgerEntriesNodes"]]
...
class ListLedgerEntriesLedgerLedgerEntriesNodesLines(BaseModel):
    nodes: Optional[List["ListLedgerEntriesLedgerLedgerEntriesNodesLinesNodes"]]
