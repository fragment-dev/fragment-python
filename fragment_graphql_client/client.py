...
class Client(AsyncBaseClient):
    ...
    async def add_ledger_entry(
        ...
        type: str,
        parameters: Any,
        posted: Union[Optional[Any], UnsetType] = UNSET,
        tags: Union[Optional[List[LedgerEntryTagInput]], UnsetType] = UNSET,
        groups: Union[Optional[List[LedgerEntryGroupInput]], UnsetType] = UNSET,
        **kwargs: Any
    ) -> AddLedgerEntry:
        query = gql(
            """
    ...
    async def list_ledger_account_balances(
        ...
        first: Union[Optional[int], UnsetType] = UNSET,
        before: Union[Optional[str], UnsetType] = UNSET,
        balance_currency: Union[Optional[CurrencyMatchInput], UnsetType] = UNSET,
        balance_at: Union[Optional[Any], UnsetType] = UNSET,
        own_balance_consistency_mode: Union[
            Optional[ReadBalanceConsistencyMode], UnsetType
        ] = UNSET,
        **kwargs: Any
    ...
    async def list_multi_currency_ledger_account_balances(
        ...
        before: Union[Optional[str], UnsetType] = UNSET,
        balance_at: Union[Optional[Any], UnsetType] = UNSET,
        own_balances_consistency_mode: Union[
            Optional[ReadBalanceConsistencyMode], UnsetType
        ] = UNSET,
        **kwargs: Any
    ) -> ListMultiCurrencyLedgerAccountBalances:
    ...
    async def get_ledger_account_lines(
        ...
        first: Union[Optional[int], UnsetType] = UNSET,
        before: Union[Optional[str], UnsetType] = UNSET,
        filter: Union[Optional[LedgerLinesFilterSet], UnsetType] = UNSET,
        **kwargs: Any
    ...
    async def list_ledger_entry_group_balances(
        ...
        filter: Union[Optional[LedgerEntryGroupBalanceFilterSet], UnsetType] = UNSET,
        **kwargs: Any
    ...
    async def get_schema(
        self, key: Any, version: Union[Optional[int], UnsetType] = UNSET, **kwargs: Any
    ) -> GetSchema:
        query = gql(
            """
    ...
    async def list_ledger_entries(
        ...
        first: Union[Optional[int], UnsetType] = UNSET,
        before: Union[Optional[str], UnsetType] = UNSET,
        filter: Union[Optional[LedgerEntriesFilterSet], UnsetType] = UNSET,
        **kwargs: Any
    ) -> ListLedgerEntries:
        query = gql(
            """
